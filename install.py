...
os.system("cp ~/Termux/conf/sources.list $PREFIX/etc/apt/sources.list")
...
os.system("cp ~/Termux/conf/nginx.conf $PREFIX/etc/nginx/nginx.conf")
os.system("cp ~/Termux/conf/default.conf $PREFIX/etc/nginx/default.conf")
os.system("mv $PREFIX/etc/php-fpm.d/www.conf.bak")
os.system("cp ~/Termux/conf/www.conf $PREFIX/etc/php-fpm.d/www.conf")
#创建网页目录
...
os.system("cp ~/Termux/index.html $PREFIX/share/nginx/html/index.html")
os.system("cp -r ~/Termux/web $PREFIX/share/nginx/html/web")
